	...
	<view class="fm-view" v-if="info">
		...
		<view class="flex-row play-box">
			<image
				...
				@tap="setWish(info.Id)"
				class="collect"
				src="../../../static/images/fm/collected.png"
				mode="widthFix"
			></image>
			<image
				v-else=""
				@tap="setWish"
				class="collect"
				src="../../../static/images/fm/collect.png"
				mode="widthFix"
			></image>
			<image
				class="change"
				@tap="changeFm('pre')"
				src="../../../static/images/fm/pre.png"
				mode="widthFix"
			></image>
			...
			<image
				...
				@tap="play"
				class="play"
				src="../../../static/images/fm/pause.png"
				mode="widthFix"
			></image>
			...
			<image
				class="change"
				@tap="changeFm('next')"
				src="../../../static/images/fm/next.png"
				mode="widthFix"
			></image>
			<image
				@tap="goComment"
				class="comment"
				src="../../../static/images/fm/coment.png"
				mode="widthFix"
			></image>
		</view>
		<view class="comment-list">
			...
			<view class="list" v-if="comment.length">
				<view class="item" v-for="(item, index) in comment" :key="index">
					<view class="flex-row">
						<view class="imgBox"><image :src="item.Avatar" mode="widthFix" /></view>
						<view class="name-box">
