			...
			<view class="list-box">
				<block v-for="(item, index) in list" :key="index">
					<view class="item" @tap="goTestView(item.Id)">
						...
						<view class="img-box"> <image :src="item.BannerPictureUrl"></image> </view>
					</view>
				</block>
			</view>
		</view>
...
export default {
	...
	methods: {
		...
		getList() {
			...
			let { PageIndex, PageSize, Category ,strWhere} = this;
			api.getList({ PageIndex, PageSize, Category,strWhere }).then(res => {
				uni.hideLoading();
				uni.stopPullDownRefresh();
